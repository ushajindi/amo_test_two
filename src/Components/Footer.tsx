        ...
        <div className="footer">
            <div className="footer__inner">
                <div className="footer__items">
                    <p className="footer__header"> О КОМПАНИИ</p>
                ...
                <div className="footer__items">
                    <p className="footer__header"> Меню</p>
                    <div className="footer__menu__inner">
                        <div className="footer__menu">
                            ...
                            <a href="#" className="footer__items__link">
                                Виджеты
                            </a><a href="#" className="footer__items__link">
                            Интеграции
                        </a>
                            <a href="#" className="footer__items__link">
                                Наши клиенты
                ...
                <div className="footer__items social">
                    <p className="footer__header"> Контакты</p>
                    <a href="tel:+7 555 555-55-55" className="footer__items__link social">
                        +7 555 555-55-55
                    </a>
                    <div className="footer__social">
                        <a className="footer__items__link" href=""><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        ...
                        </svg></a><a className="footer__items__link" href="">
