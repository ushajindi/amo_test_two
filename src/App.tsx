...
function App() {
    ...
    <div className="wrapper">
        <div className="container">
            ...
            <div className="red__light__ball"></div>
        <div className="purple__light__ball"></div>
        <div className="ball__one">
        ...
        {/* Если задумано анимация шаров то можно в компонетне Balls реализовать
            <Balls>
                <svg xmlns="http://www.w3.org/2000/svg" width="117" height="117" viewBox="0 0 117 117" fill="none">
                    <g filter="url(#filter0_bd_0_13)">
                        <circle cx="55.5" cy="52.5" r="41.5" fill="url(#paint0_radial_0_13)" fill-opacity="0.8" shape-rendering="crispEdges"/>
